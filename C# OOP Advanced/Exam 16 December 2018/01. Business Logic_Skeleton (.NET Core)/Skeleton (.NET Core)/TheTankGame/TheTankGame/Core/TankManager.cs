namespace TheTankGame.Core
{
    ...
    public class TankManager : IManager
    {
        ...
        //TODO probably change dictionary to list
        ...
        public string Terminate(IList<string> arguments)
        {
            ...
            foreach (var v in this.vehicles.Values)
            {
                usedParts += v.Parts.ToList().Count;
            }

            finalResult
                .Append("Currently Used Parts: ")
                .Append(usedParts);
                //.Append(this.parts.Count); TODO might be correct
